...
public class StopCarForm extends AppCompatActivity implements ValueEventListener,
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stop_car_form);
...
//
//        btnSendImageWithCamera.setOnClickListener(new View.OnClickListener() {
//            @Override
...
//        btnSendAudio.setOnClickListener(this);
        ...
        btnMoreInfo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent iMoreInfo = new Intent(StopCarForm.this,MoreInfoActivity.class);
    ...
    protected void onStart() {
        super.onStart();
        messageController = new MessageController(StopCarForm.this,uidFriendChat,recyclerViewMessage);
    }
...
//                break;
            case R.id.btnBackMessages:
                Intent iFriendFragment = new Intent(StopCarForm.this,MainActivity.class);
